...
- UA3F：`ua3f`
  ...
  安装时若显示`Connection reset prematurely`说明域名不可访问，要修改`install.sh`，使各个文件路径与`cdn.jsdelivr.net/gh/SunBK201/UA3F@master/`下的文件路径一一对应。见[ua3f_install.sh](./ua3f_install.sh)
