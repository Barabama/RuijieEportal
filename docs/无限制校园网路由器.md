...
# 20251101 gengx: UA3F作者已经更新1.0版本，详见https://github.com/SunBK201/UA3F/releases/tag/v1.1.0
opkg update
opkg install luci-compat ipset iptables kmod-nft-tproxy iptables-mod-tproxy iptables-mod-extra iptables-mod-nat-extra kmod-ipt-conntrack
cd /tmp
wget https://gh-proxy.com/github.com/SunBK201/UA3F/releases/download/v1.1.0/ua3f_1.1.0-1_mipsle-softfloat.ipk
opkg install ua3f_1.1.0-1_mipsle-softfloat.ipk
...
- Shell实现登录
  ...
  > **2026-08 更新**: `encrypt.c` 已从 GMP 迁移到 **libtommath** (见 [README](../README.md)),
  > 无需再交叉编译 GMP. 用 musl.cc 工具链单命令编译即可, GitHub Actions 已自动化三平台构建.
  > 下面的 GMP 交叉编译过程仅作历史记录保留.

  - 交叉编译`encrypt.c` (旧 GMP 方案, 已弃用)

```shell
## gmp编译工具链
sudo apt install make gcc m4 -y
cd /home/ubar24/projects/RuijieEportal/build
...
# 配置环境变量
export STAGING_DIR=/home/ubar24/projects/RuijieEportal/build/immortalwrt-sdk-23.05.4-ramips-mt7621_gcc-12.3.0_musl.Linux-x86_64/staging_dir/toolchain-mipsel_24kc_gcc-12.3.0_musl
export PATH=$PATH:$STAGING_DIR/bin
# export STAGING_DIR=/home/ubar24/projects/RuijieEportal/build/immortalwrt-sdk-24.10.4-ramips-mt7621_gcc-13.3.0_musl.Linux-x86_64/staging_dir/toolchain-mipsel_24kc_gcc-13.3.0_musl
# export PATH=$PATH:$STAGING_DIR/bin
mipsel-openwrt-linux-gcc --version # 查看gcc是否安装成功

# 编译gmp
cd /home/ubar24/projects/RuijieEportal/build
wget https://gmplib.org/download/gmp/gmp-6.3.0.tar.gz # 下载gmp
rm -rf gmp-6.3.0
tar -xvf gmp-6.3.0.tar.gz
cd /home/ubar24/projects/RuijieEportal/build/gmp-6.3.0
make clean
./configure --host=mipsel-openwrt-linux-musl --prefix=/home/ubar24/projects/RuijieEportal/build/gmp-mipsel --enable-static --disable-shared CC=mipsel-openwrt-linux-musl-gcc --disable-assembly --disable-fat --disable-profiling # 如果配置或make失败尝试添加参数
make -j4
make install

## 交叉编译encrypt.c
cd /home/ubar24/projects/RuijieEportal
mipsel-openwrt-linux-musl-gcc -static -I/home/ubar24/projects/RuijieEportal/build/gmp-mipsel/include -L/home/ubar24/projects/RuijieEportal/build/gmp-mipsel/lib src/encrypt.c -o dist/encrypt_mipsel -lgmp
```
...
opkg install luci-app-ttyd luci-app-argon-config luci-app-fileassistant
cd /tmp
wget https://gh-proxy.com/github.com/lucikap/luci-app-nettask/blob/main/luci-app-nettask_2.0.0-1_all.ipk
opkg install luci-app-nettask_2.0.0-1_all.ipk
